                 ...
                 <div class="row">
                   <div class="container-block">
                      <div class="row space-bottom-sm">
                         <div class="col-sm-15">
                            <h1 class="panel-title">CISCO CCNA (200-120): The Complete Course</h1>
                         </div>
                         <div class="col-sm-9 col-top">
                            <a target="_blank" title="See all courses by Ofcourse" href="#">
                            <img src="<?php echo $base_url; ?>assets/images1/logos/ofcourse_organiser-126_logoa95c.png" class="img-responsive pull-right">
                            </a>
                         </div>
                      </div>
                      <div class="row">
                         <div class="col-sm-15">
                            <p class="text-muted">
                               By <a class="text-muted" target="_blank" href="#">  Ofcourse </a>
                            </p>
                         </div>
                         <div class="col-sm-9">
                            <button onclick="modalOpen('modal_1')" class="btn btn-section btn-lg btn-block col-sm-24">
                            Enroll Now
                            </button>
                            <div class="text-center">
                               <span class="text-sm">(Instant booking on GulfTalent)</span>
                            </div>
                         </div>
                      </div>
                   </div>
                 </div>
                 <ul class="nav nav-tabs space-bottom-med">
                    <li id="course_overview_text" class="active">
                       <a class="text-med text-secondary">Overview</a>
                    </li>
                    <li id="course_contents_text">
                       <a class="text-med text-secondary">Contents</a>
                    </li>
                    <li id="course_provider_text">
                       <a class="text-med text-secondary">Provider</a>
                    </li>
                 </ul>
                 <div id="course_overview">
                    <div class="row space-bottom-med">
                       <div class="col-sm-12">
                          <div class="media" style="height: 40px;">
                             <div class="media-object pull-left">
                                <div class="icon icon-circle icon-1x icon-circle-section">
                                   <i class="fa fa-map-marker"></i>
                                </div>
                             </div>
                             <div class="media-body">
                                <strong class="text-secondary">Location</strong><br>
                       ...
                       <div class="col-sm-12">
                          <div class="media" style="height: 40px;">
                             ...
                             <div class="media-body">
                                <strong class="text-secondary">Dates</strong><br>
                                <span class="text-muted">
                    ...
                    <div class="row space-bottom-med">
                       <div class="col-sm-12">
                          <div class="media" style="height: 40px;">
                             ...
                             <div class="media-body">
                                <strong class="text-secondary">Course Type</strong><br>
                                <span class="text-muted">
                       ...
                       <div class="col-sm-12">
                          <div class="media" style="height: 40px;">
                             ...
                             <div class="media-body">
                                <strong class="text-secondary">Accreditation</strong><br>
                                <span class="text-muted">
                    ...
                    <div class="row space-bottom-med">
                       <div class="col-sm-12">
                          <div class="media" style="height: 40px;">
                             ...
                             <div class="media-body">
                                <strong class="text-secondary">Language</strong><br>
                                <span class="text-muted">
                                English
                                </span>
                             </div>
                       ...
                       <div class="col-sm-12">
                          <div class="media" style="height: 40px;">
                             ...
                             <div class="media-body">
                                <strong class="text-secondary">Course Fee</strong><br>
                                <del><span class="text-muted">$325</span></del>
                                <span class="text-primary">$69 only</span>
                             </div>
                          </div>
                       </div>
                    </div>
                    ...
                    <div id="truncate">
                       <p>This complete Cisco CCNA course will cover everything you need to prepare for the 200-120 certification exam!</p>
                       <p>This course is over 24+ hours in length and will cover all the needed subjects to be successful in passing your CCNA 200-120 exam; also the knowledge and practice labs acquired in this course will be transferable to real world use as a Cisco professional.</p>
                    </div>
                 </div>
                 <div id="course_contents" style="display:none">
                    <h4>Course content</h4>
                    <div class="truncate" style="height: 160px;">
                       <p>Part 1 – Welcome and be amazed!</p>
                       <p>Part 2 – The Packet Tracer Simulator</p>
                       <p>Part 3 – Networking Basics</p>
                       <p>Part 4 – The OSI Model</p>
                       <p>Part 5 – Binary to hex and decimal conversion</p>
                       <p>Part 6 – CISCO 3 Layer Model</p>
                       <p>Part 7 – TCP/IP Model</p>
                       <p>Part 8 – Ethernet Networks</p>
                       <p>Part 9 – IPV 4</p>
                       <p>Section 10: Private IP address range</p>
                       <p>Section 11: IPv6 Addressing</p>
                       <p>Section 12: Transition Mechanisms</p>
                       <p>Section 13: How to subnet in IPv4</p>
                       <p>Section 14: How to subnet in IPv6</p>
                       <p>Section 15: Inside a Cisco router</p>
                       <p>Section 16: Administrative configurations</p>
                       <p>Section 17: DHCP and Name resolution on Cisco routers</p>
                       <p>Section 18: Using the Cisco Discovery Protocol</p>
                       <p>Section 19: The Cisco register</p>
                       <p>Section 20: Routing Process</p>
                       <p>Section 21: Dynamic Routing</p>
                       <p>Section 22: OSPF Details</p>
                       <p>Section 23: Switching at Layer 2</p>
                       <p>Section 24: The basics of VLANs</p>
                       <p>Section 25: The Spanning-tree Protocol</p>
                       <p>Section 26: The Virtual Trunking Protocol</p>
                       <p>Section 27: Inter-vlan routing</p>
                       <p>Section 28: Secure your Enterprise using ACL’s</p>
                       <p>Section 29: Network Address Translations</p>
                       <p>Section 30: Summary</p>
                    </div>
                    <p>
                      <a class="text-strong">+ show more</a>
                      <a class="text-strong" style="display: none;">- show less</a></p>
                 </div>
                 <div id="course_provider" style="display:none">
                    <h4>About Course Provider</h4>
                    <div>
                       <p>Ofcourse.co.uk is a self improvement and development learning platform. Our courses are created by genuine and verified subject matter experts, and delivered in easy access, on demand video-led courses. The experts can be experienced professionals, university lecturers or even world record holders in their fields!</p>
                       <p>Anyone can learn anything online with OfCourse! Of Course Learning is a UK Registered Learning Provider.</p>
                    </div>
                 </div>

                 <h4 class="header-ribbon" id="how-to-enroll">How to enroll?</h4>
                 <div class="row space-top-xl">
                   <div class="col-sm-10 col-sm-offset-7">
                      <button onclick="modalOpen('modal_1')" class="btn btn-primary btn-lg btn-block col-sm-24">
                      Enroll Now
                      </button>
                      <div class="text-center">
                         <span class="text-sm">(Instant booking on GulfTalent)</span>
                   ...
                   <div class="collapse in space-bottom-sm">
                     ...
                     <div class="collapsible-body collapse" style="height: auto;">
                       <div class="space-top-sm space-bottom-sm space-left-xs text-regular text-base text-gray">
                         You will instantly receive a confirmation email from GulfTalent with a unique Purchase Reference number, once you buy a course on GulfTalent.The details to start the course will be sent to you by email along with it or soon after. In case of online courses, you may be asked to register on the course provider's website in order to begin your course.
                       </div>
                     </div>
                   </div>
                   <div class="collapse in space-bottom-sm">
                     ...
                     <div class="collapsible-body collapse" style="height: auto;">
                       <div class="space-top-sm space-bottom-sm space-left-xs text-regular text-base text-gray">
                         Course delivery and fulfilment are the sole responsibility of the course provider. GulfTalent simply acts as a booking platform connecting you to the course provider. Course provider reserves the right to change the course content at any time.
                       </div>
                     </div>
                   </div>
                   <div class="collapse in space-bottom-sm">
                     <div class="row collapsible-toggle-title space-bottom-sm custom-collapsible-toggle">
                       <i class="fa fa-fw col-sm-2 fa-caret-right text-color"></i>
                       <span class="text-base text-link col-sm-22 text-gray">
                         How do I get in touch with the provider of the course I have purchased?
                       </span>
                     </div>
                     <div class="collapsible-body collapse" style="height: auto;">
                       <div class="space-top-sm space-bottom-sm space-left-xs text-regular text-base text-gray">
                         Your purchase confirmation email will include the contact details of the course provider. We also send the provider your contact details and your unique Purchase Reference number when you make the purchase so that they can get in touch with you if required. The Purchase Reference number can be used in your communications with the course provider.
                         <br><br>
                         <strong>Note</strong>: We do not share your contact details with the provider until you complete your course purchase.
                       </div>
                     </div>
                   </div>
                 </div>
      ...
      <div class="modal-content">
        <div>
          <div class="modal-header">
            <h2 class="modal-title">Enroll now to</h2>
            <button class="close" onclick="modalClose('modal_1')" >
              <i class="fa fa-remove"></i>
            </button>
          </div>
          <div class="modal-body">
            <div class="container-block space-bottom-med">
              <div class="row">
                <div class="col-sm-16">
                  <p class="text-xl text-strong panel-title">CISCO CCNA (200-120): The Complete Course</p>
                  <p class="text-muted ng-binding">
                    Online, Provided by Ofcourse
                  </p>
                  <p>
                    <span class="text-muted">Price:</span>
                    <span class="text-muted">
                      <del class="ng-binding">$325.00</del>
                    </span>
                    <span class="text-heading text-xxl">
                      $69.00
                    </span>
                  </p>
                </div>
              ...
              <div class="row">
                <div class="col-sm-22 col-sm-offset-1">
                  <img src="<?php echo $base_url; ?>assets/images1/purchase_steps.png" class="img-responsive">
                </div>
              </div>
            </div>
            <form class="form-horizontal form-light">
              <div class="form-group form-group-sm">
                <label class="col-sm-9 control-label required" for="course_purchase_name">
                  Full Name
                  <span class="text-primary">*</span>
                </label>
                <div class="col-sm-10">
                  <input type="text" id="course_purchase_name" name="name" required="required" class="form-control input-sm">
                </div>
              </div>
              <div class="form-group form-group-sm">
                <label class="col-sm-9 control-label required" for="course_purchase_job_title">
                  Your Job Title
                  <span class="text-primary">*</span>
                </label>
                <div class="col-sm-10">
                  <input type="text" id="course_purchase_job_title" name="job_title" required="required" class="form-control input-sm">
                </div>
              </div>
              <div class="form-group form-group-sm">
                <label class="col-sm-9 control-label" for="course_purchase_mobile">
                  Phone (Mobile)
                </label>
                <div class="col-sm-10">
                  <input type="text" id="course_purchase_mobile" name="mobile" placeholder="e.g. +971 4 234 2999" class="form-control input-sm">
                </div>
              </div>
              <div class="form-group form-group-sm">
                <label class="col-sm-9 control-label required" for="course_purchase_country">
                  Your Location
                  <span class="text-primary">*</span>
                </label>
                <div class="col-sm-10">
                  <select id="course_purchase_country" name="country" required="required" class="form-control input-sm">
              ...
              <div class="form-group form-group-sm" style="display: none;">
                <label class="col-sm-9 control-label required" for="course_purchase_city">
                  City
                  <span class="text-primary">*</span>
                </label>
                <div class="col-sm-10">
                  <select id="course_purchase_city" name="city" class="form-control input-sm">
                    <option value="" disabled="disabled" selected="selected">Select</option>
                    <option value="10111111000111">Dubai</option>
                    <option value="10111111000112">Abu Dhabi</option>
                    <option value="10111111000113">Sharjah</option>
                    <option value="10111111000114">Ajman</option>
                    <option value="10111111000115">Al Ain</option>
                    <option value="10111111000116">Fujairah</option>
                    <option value="10111111000117">Ras Al Khaimah</option>
                    <option value="10111111000118">Umm Al Quwain</option>
                  </select>
                </div>
              </div>
              <div class="form-group form-group-sm">
                <label class="col-sm-9 control-label required" for="course_purchase_email">
                  Email Address
                  <span class="text-primary">*</span>
                </label>
                <div class="col-sm-10">
                  <input type="email" id="course_purchase_email" name="email" required="required" class="form-control input-sm">
                </div>
              </div>
              <div class="checkbox text-center space-top-lg space-bottom-lg">
                <label class="text-muted">
                  <input type="checkbox" id="course_purchase_terms_of_service" name="terms_of_service" required="required" class="col-middle" value="1">
                  I agree to GulfTalent’s
                  <a href="<?php echo $base_url; ?>terms_condition/terms.php" target="_blank">Terms of Service</a>.
                </label>
              </div>
              <div class="form-group form-group-sm space-top-lg">
                <div class="col-sm-10 col-sm-offset-9">
                  <button type="submit" class="btn btn-med btn-primary">Proceed to Payment</button>
                </div>
                <div class="col-sm-17 col-sm-offset-7 space-top-sm">
                  <p class="text-sm">(Credit card and Debit card payments accepted)</p>
                </div>
              </div>
            </form>
          </div>
