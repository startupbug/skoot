               ...
               <div class="panel-body">
                 <div class="row">
                   <div class="container-block">
                      ...
                      <div class="row">
                         ...
                         <div class="col-sm-9">
                            <button onclick="document.getElementById('id01').style.display='block'"  class="btn btn-section btn-lg btn-block col-sm-24">
                            Enroll Now
                            </button>
                 ...
                 <div class="row space-top-xl">
                   <div class="col-sm-10 col-sm-offset-7">
                      <button class="btn btn-primary btn-lg btn-block col-sm-24">
                      Enroll Now
                      </button>
                      <div class="text-center">
                         <span class="text-sm">(Instant booking on GulfTalent)</span>
         ...
         <div class="modal-content">
           <div>
             <div class="modal-header">
               ...
               <button class="close" onclick="document.getElementById('id01').style.display='none'" >
