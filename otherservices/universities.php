   ...
   <div class="">
      ...
      <div style="background-image: url(<?php echo $base_url;?>assets/img/featured/universities_img.png)" class="jumbotron bg-cover">
         <div class="container space-top-lg space-bottom-lg">
            <div class="row">
               <div class="col-sm-24">
                  <h1 class="text-center space-top-lg space-bottom-lg">
                     Career Services Support<br>for Universities 
                  </h1>
               </div>
            </div>
            <div class="row row-xs-height">
               ...
               <div class="col-xs-height col-middle col-xs-10 text-left">
                  <a gt-modal-contact-forms-contact-us="" class="btn btn-tertiary btn-lg f_btn_call">
                  Request a Call back
                  </a>
               </div>
            </div>
            ...
            <div class="row space-top-xl space-bottom-lg">
               ...
               <div class="col-sm-18">
                  ...
                  <h2 class="text-left space-top-xl space-bottom-xl text-muted">
                     ...
                     <span class="text-elegant f_reach"> employers in the Middle East</span>
                  </h2>
               </div>
            </div>
         </div>
      ...
      <section class="bg-dark">
         <div class="container">
            <div class="row space-top-xl space-bottom-lg">
               <h2 class="text-hg text-center space-bottom-xl">Benefit from a range of services for your students</h2>
               <div class="col-sm-8">
                  <div class="media text-center">
                     <div class="media-object inline f_media">
                        <div class="icon icon-circle icon-3x icon-circle-section hover-expand f_icon_media">
                           <i class="fa fa-briefcase text-secondary f_curved"></i>
                        </div>
                     </div>
                  </div>
               ...
               <div class="col-sm-8">
                  <div class="media text-center">
                     <div class="media-object inline f_media">
                        <div class="icon icon-circle icon-3x icon-circle-section hover-expand f_icon_media">
                           <i class="fa fa-graduate-hat-sharp text-secondary f_curved"></i>
                        </div>
                     </div>
                  </div>
                  <div class="text-lg text-muted text-heading space-top-lg text-center">
                  ...
                  <p class="text-center text-muted text-elegant text-xl f_entry">Connect with employers to find<br />internships</p>
               </div>
               <div class="col-sm-8">
                  <div class="media text-center">
                     <div class="media-object inline f_media">
                        <div class="icon icon-circle icon-3x icon-circle-section hover-expand f_icon_media">
                           <i class="fa fa-tie text-secondary f_curved"></i>
                        </div>
                     </div>
                  </div>
                  <div class="text-lg text-muted text-heading space-top-lg text-center">
                  ...
                  <p class="text-center text-muted text-elegant text-xl f_entry">Promote your career day among<br />employers in your country</p>
               </div>
            </div>
         </div>
      </section>
      <section class="bg-light">
         <div class="container">
            <div class="row space-top-xl space-bottom-xl">
               <h2 class="text-hg text-center space-bottom-xl">Job Search Support</h2>
               <div class="col-sm-8 text-center">
                  <i class="fa fa-book fa-4x text-muted"></i>
                  <h3 class="f_num">Career Day Guide</h3>
               </div>
               <div class="col-sm-8 text-center text-muted">
                  <i class="fa fa-cv fa-4x"></i>
                  <h3 class="f_num">Free CV Builder</h3>
               </div>
               <div class="col-sm-8 text-center text-muted">
                  <i class="fa fa-handshake fa-4x"></i>
                  <h3 class="f_num">Public Career Fairs</h3>
               </div>
            </div>
         </div>
      </section>
...
<section class="bg-cover jumbotron" style="background-image: url(<?php echo $base_url;?>assets/img/featured/event_bottom.png)">
      ...
      <section class="bg-light f_bg">
         <div class="container">
            <div class="row">
               <h2 class="text-hg text-center space-top-xl space-bottom-sm f_look">Looking to promote executive education programs?</h2>
               <h3 class="text-elegant text-center f_check">Checkout our <a href="<?php echo $base_url;?>courses/search.php" class="course_f"> course listing options!</a></h3>
            </div>
         </div>
      </section>
   </div>
