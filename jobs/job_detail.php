              ...
              <div class="col-sm-8 hidden-print">
                 ...
                 <div class="panel panel-default">
                    <div class="list-group">
                       <a class="list-group-item" onclick="modalOpen('cv_modal')">
                          <div class="media">
...
<div id="cv_modal" class="w3-modal">
     ...
     <div class="modal-content">
        <div>
           <div class="modal-header">
              ...
              <button class="close" onclick="modalClose('cv_modal');">
              <i class="fa fa-remove"></i>
              </button>
           </div>
           <div class="modal-body">
              ...
              <form action="#" enctype="multipart/form-data" id="registration-step1" method="post" novalidate="" class="form-horizontal show-print-block section-jobs" name="registrationForm">
                 <div class="container-block container-xs-height">
                    <div class="row row-xs-height">
                       <div class="col-sm-12 col-sm-offset-1 col-xs-height">
                          <div class="form-group">
                             <div class="col-sm-12">
                                <input type="text" id="candidate_firstname" name="firstname" required="required" class="form-control" placeholder="First Name">
                             </div>
                             <div class="col-sm-12">
                                <input type="text" id="candidate_surname" name="surname" required="required" class="form-control" placeholder="Surname">
                             </div>
                          </div>
                          <div class="form-group">
                             <div class="col-sm-24">
                                <select id="candidate_CanLoc_location_current" name="CanLoc_location_current" required="required" class="form-control">
                          ...
                          <div class="form-group">
                             <div class="col-sm-24">
                                <input type="email" id="candidate_username" name="username" required="required" class="form-control" placeholder="Email address">
                             </div>
                          </div>
                          <div class="form-group">
                             <div class="col-sm-24">
                                <input type="password" id="candidate_password" name="password" required="required" class="form-control" placeholder="Choose a Password">
                             </div>
                          </div>
                       </div>
                       ...
                       <div class="col-sm-9 col-xs-height col-middle">
                          <div class="row">
                             <div class="col-sm-20">
                                <button type="button" class="btn btn-block btn-brand-facebook">
                                <i class="fa fa-fw fa-facebook-square text-left"></i>
                                Sign up with Facebook
                                </button>
                             </div>
                 ...
                 <div class="row space-top-xs">
                    <div class=" col-sm-16 col-sm-offset-5 ">
                          ...
                          <div class="col-sm-8">
                             <div class="row">
                                <div class="text-danger text-center" style="display: none;">
                                   Adobe Flash Player is required to upload your CV.
                                   <a target="_blank" href="https://get.adobe.com/flashplayer/">Install Adobe Flash Player</a>
                                </div>
                                <div class="col-sm-20 col-sm-offset-2">
                                   <div class="btn btn-tertiary btn-block btn-upload col-sm-24">
                                      Choose File
                                      <input type="file" name="file" class="input-blk"  required="required">
                                      <input name="file" class="input-blk" required="required"  style="display: none;">
                                   </div>
                                </div>
                             </div>
                             <div class="row space-top-xs">
                                <div class="col-sm-16 col-sm-offset-4 label label-default" style="display: none;">
                                   <span class="close space-top-xs">x</span>
                                   <div class="text-link space-top-sm space-bottom-sm text-overflow">
                                   </div>
                                </div>
                             </div>
                          </div>
                       ...
                       <p class="text-muted">
                          By clicking Register, you agree to Joblane's
                            <a href="<?php echo $base_url; ?>terms_condition/terms.php">Terms</a>,
                            <a href="<?php echo $base_url; ?>terms_condition/privacy_policy.php">Privacy Policy</a>
                          and
                          <a>
                       ...
                       <div>
                          <div class="form-group">
                             <div class="col-sm-1">
                                <input type="checkbox" id="mailing_MailpoolPermissionTypeTwo" name="mailing[MailpoolPermissionTypeTwo" value="YES">
                             </div>
                          ...
                          <div class="form-group">
                             <div class="col-sm-1">
                                <input type="checkbox" id="mailing_MailpoolPermissionTypeThree" name="mailing[MailpoolPermissionTypeThree" value="YES">
                             </div>
                             <span class="text-muted col-sm-22 col-sm-offset-1">
                             Please inform me about events, products and services from GulfTalent partners which may be of interest to me.
                             </span>
                       ...
                       <div class="form-group">
                          <div class="col-sm-24">
                             <button class="btn btn-primary btn-block btn-lg col-sm-20" type="submit">
              ...
              <div class="row">
                 ...
                 <h3 class="text-left text-lg space-bottom-none">
                    Already a registered candidate?
                    <a  onclick="modalOpen('login_modal'); modalClose('cv_modal');">
                    Log in
                    </a>
                 </h3>
              </div>
