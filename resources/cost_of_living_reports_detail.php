                                  ...
                                  <div class="col-sm-offset-7 col-sm-10">
                                    <div class="panel panel-default panel-bordered">
                                      <div class="panel-body">
                                          ...
                                          <button type="button" onclick="modalOpen('costofliving_modal')" class="btn btn-primary btn-lg btn-block col-sm-24">
                                              Buy Now
                                          </button>
                                      </div>
                                    </div>
...
<div id="costofliving_modal" class="w3-modal">
  <div class="modal-dialog" style="">
     <div class="modal-content">
        <div class="modal-header">
           <h2 class="modal-title">Confirm Your Order</h2>
           <button  class="close" onclick="modalClose('costofliving_modal')">
        ...
        <div class="modal-body">
           <table class="table table-condensed">
              <thead>
                 <tr>
                    <th class="col-sm-20">Report</th>
                    <th class="col-sm-4">Price</th>
                 </tr>
              </thead>
              <tbody>
                 <tr>
                    <td>Cost of Living UAE Report 2016-17 (Full Report)</td>
                    <td>$ 1950</td>
                 </tr>
              </tbody>
           </table>
           <form class="form-horizontal form-light">
              <div class="form-group form-group-sm">
                 <label class="col-sm-9 control-label required" for="employer_enquiry_name">
                 Full Name
                 <span class="text-primary">*</span></label>
                 <div class="col-sm-10">
                    <input type="text" id="employer_enquiry_name" name="name" required="required" maxlength="50" class="form-control input-sm">
                 </div>
              </div>
              <div class="form-group form-group-sm">
                 <label class="col-sm-9 control-label required" for="employer_enquiry_job_title">
                 Your Job Title
                 <span class="text-primary">*</span></label>
                 <div class="col-sm-10">
                    <input type="text" id="employer_enquiry_job_title" name="job_title" required="required" maxlength="50" class="form-control input-sm">
                 </div>
              </div>
              <div class="form-group form-group-sm space-top-lg">
                 <label class="col-sm-9 control-label required" for="employer_enquiry_company_name">
                 Company Name
                 <span class="text-primary">*</span></label>
                 <div class="col-sm-10">
                    <input type="text" id="employer_enquiry_company_name" name="company_name" required="required" maxlength="50" class="form-control input-sm">
                 </div>
              </div>
              <div class="form-group form-group-sm">
                 <label class="col-sm-9 control-label required" for="employer_enquiry_location">
                 Company Location
                 <span class="text-primary">*</span></label>
                 <div class="col-sm-10">
                    <select id="employer_enquiry_location" name="location" required="required" class="form-control input-sm">
              ...
              <div class="form-group space form-group-sm-top-lg">
                 <label class="col-sm-9 control-label required" for="employer_enquiry_contact_number">
                 Phone (Landline)
                 <span class="text-primary">*</span></label>
                 <div class="col-sm-7">
                    <input type="text" id="employer_enquiry_contact_number" name="contact_number" required="required" maxlength="50" placeholder="e.g. +971 4 234 2999" class="form-control input-sm">
                 </div>
                 <div class="col-sm-3">
                    <input type="text" id="employer_enquiry_tele_extension" name="tele_extension" maxlength="6" placeholder="Ext." class="form-control input-sm">
                 </div>
              </div>
              <div class="form-group form-group-sm">
                 <label class="col-sm-9 control-label" for="employer_enquiry_mobile">
                 Phone (Mobile)
                 </label>
                 <div class="col-sm-10">
                    <input type="text" id="employer_enquiry_mobile" name="mobile" maxlength="50" class="form-control input-sm">
                 </div>
              </div>
              <div class="form-group form-group-sm">
                 <label class="col-sm-9 control-label required" for="employer_enquiry_email_id">
                 Email Address (Work)
                 <span class="text-primary">*</span></label>
                 <div class="col-sm-10">
                    <input type="email" id="employer_enquiry_email_id" name="email_id" required="required" maxlength="50" class="form-control input-sm">
                 </div>
              </div>
              <div class="form-group form-group-sm">
                 ...
                 <div class="col-sm-10 space-top-xs">
                    <label>
                    <input type="radio" value="card" name="00L">
                    Credit Card (Get the Report Instantly)
                    </label><br>
                    <label>
                    <input type="radio" value="transfer" name="00M">
                    Bank Transfer
                    </label>
                 </div>
              </div>
              <div class="checkbox text-center space-top-lg space-bottom-lg">
                 ...
                 <input type="checkbox" name="terms_of_service" required="required" class="col-middle" value="1">
                 I agree to GulfTalent’s
                 <a href="<?php echo $base_url; ?>terms_condition/terms.php" target="_blank">
                 Terms of Service
                 </a>.
                 </label>
              </div>
              <div class="form-group form-group-sm space-top-lg">
                 <div class="col-sm-5 col-sm-offset-9">
                    <button type="submit" class="btn btn-med btn-block btn-primary">Submit</button>
                 </div>
              </div>
           </form>
        </div>
