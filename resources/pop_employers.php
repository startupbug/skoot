      ...
      <div class="panel panel-default">
         ...
         <div class="list-group">
            <div class="list-group-item"
               ...
               <p>Saudi Aramco has once again been voted the employer of choice for Saudi male graduates, followed by SABIC in second place, according to a survey of KFUPM graduates released by JobLane.</p>
               ...
               <p>Oil services company Schlumberger, coming in third place, was the most popular multinational employer. The company has had a consistently high ranking in JobLane’s surveys of KFUPM graduates since 2005.</p>
               ...
               <table cellspacing="20px" style="margin: 10px auto; width: 550px; background: #f7f7f7">
                  <tbody>
                     ...
                     <tr>
                        <td colspan="2" style="margin-top: 20px; padding-left: 10px; padding-bottom: 10px;"><em>Source: JobLane Survey of KFUPM Graduates</em></td>
                     </tr>
                  </tbody>
               </table>
               <p><br />
               ...
               <p>Unlike previous years, however, none of the banks made it to the top 20 list this year, with some graduates citing lack of job security in banking as a concern. The variation of rankings over the years can be found in the <a href="#">full report<i class="text-section fa fa-fw fa-file-pdf-o"></i></a>.</p>
               <p><strong>Key Attraction Factors</strong></p>
               <p>JobLane’s survey asked graduates about the factors that drove them to choose their preferred employer. The top three factors mentioned were the quality of the training and development programme, the opportunity to do interesting and challenging work, and good salary and benefits. Job security and company brand and reputation were also cited as important factors.</p>
               ...
               <p>Hamad, an Industrial Engineering graduate who named Aramco as his first choice, told JobLane interviewers “The training you get with Aramco is excellent. And I also like the fact that they have many international partnerships and send you on projects abroad”.</p>
               ...
               <p>Additional information and insights about employment preferences of Saudi graduates can be found in the <a href="#">full report<i class="text-section fa fa-fw fa-file-pdf-o"></i></a>.</p>
               <p><a href="#"><img src="../../images/branding-banner-2016.png"></a></p>
               <p><strong>Survey Methodology</strong></p>
               <p>JobLane’s study was based on a survey of 224 recent graduates and final-year students from King Fahd University of Petroleum &amp; Minerals (KFUPM). The survey was conducted during June-July 2016, after the publication of the Saudi Vision 2030, but prior to the announcement of pay cuts for the Saudi public sector.</p>
               ...
               <div class="text-center">
                  <p><a href="#"><img src="../../images/banner-saudi-graduates-2016.png"></a></p>
               </div>
            </div>
            <a href="#" class="list-group-item-main hidden-print">
      ...
      <div class="panel panel-default hidden-print">
         ...
         <div class="panel-body hidden-print">
            ...
            <form class="form-horizontal" action="https://www.gulftalent.com/resources/employment-news/aramco-and-sabic-voted-most-popular-employers-for-saudi-graduates-74" method="post">
               ...
               <input type="hidden" id="articleComment_captcha_expression" name="captcha_expression" class="form-control input-lg" value="13 + 5" />
               <input type="hidden" id="articleComment_captcha_token" name="captcha_token" class="form-control input-lg" value="9e6a55b6b4563e652a23be9d623ca5055c356940" />
               <div class="row">
