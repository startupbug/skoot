             ...
             <div class="row">
              <div class="col-sm-16 reset-width">
                <div class="panel panel-default">
                  <div class="panel-heading">
                   ...
                   <div class="list-group vwo_loaded vwo_loaded_70">
                      <div class="list-group-item">
                         ...
                         <p>The research report was based on JobLane’s survey of 700 employers and 25,000 professionals across the six GCC states. Drawing on its survey results, the study found that salaries across the GCC are forecast to increase at an average of just 5.2 percent in 2016, down from 5.7 percent in the previous year.</p>
                         <div class="text-center">
                            <p><img src="<?php echo $base_url; ?>assets/images/articles/average-salary-increase-gcc-2016.png" alt=""></p>
                         </div>
                         ...
                         <div class="text-center">
                            <p><img src="<?php echo $base_url; ?>assets/images/articles/salary-increase-by-country-2016.png" alt=""></p>
                         </div>
                         <a href="/jobs" target="_blank" class="list-group-item " style="display: none;"><i class="fa fa-fw fa-chevron-right text-primary"></i>Find latest jobs in your field</a>
                         <p><strong class="">Recruitment slowdown</strong></p>
                         ...
                         <div class="text-center">
                            <p><img src="<?php echo $base_url; ?>assets/images/articles/redundancies-by-country-2016.png" alt=""></p>
                         </div>
                         <p>Several executives interviewed by JobLane reported that, despite operating below capacity, they were holding on to their specialist talent in the hope that the market will recover later in the year. If the current situation persisted, however, they would have no choice but to make painful cuts, the report quoted. </p>
                         <p>JobLane’s study also noted that, despite a marked slowdown, the situation in Gulf countries remains far more stable than in most other oil-dependent economies. According to the Economist Intelligence Unit, all GCC countries are expected to have stable currencies and register a positive economic growth in 2016, with governments using their reserves to maintain critical investments. This is in sharp contrast to Russia where the oil price collapse has already led to severe recession and a 50 percent plunge in the value of the currency since 2014. </p>
                         <p><em style="display: none;">To browse through professional jobs by top employers in the Middle East, visit <a href="/jobs"><strong>latest jobs</strong></a>.</em></p>
                         <p><em style="display: none;">If you are an employer looking to hire top talent, find out how JobLane can help you <a href="/employers"><strong>build your team</strong></a>.</em></p>
                      </div>
                      <a class="list-group-item-main hidden-print ng-scope">
                      Subscribe to receive similar articles <i class="fa fa-angle-double-right"></i>
                      </a>
                      <div class="">
                        <a href="<?php echo $base_url;?>resources/market_research_report_detail.php" target="_blank" class="list-group-item ">
                          <i class="fa fa-fw fa-chevron-right text-primary"></i>
                          Download full salary report
                        </a>
                      </div>
                      <div class=""><a class="list-group-item " href="<?php echo $base_url;?>jobs/search_job.php" target="_blank"><i class="fa fa-fw fa-chevron-right text-primary"></i>
                         Find latest jobs in your field</a>
                      </div>
                   </div>
                </div>
                   ...
                   <div class="panel-body hidden-print">
                      ...
                      <form class="form-horizontal" action="#" method="post">
                         ...
                         <div class="form-group">
                            <div class="radio">
                               <label>
                               <input type="radio" name="comment_type" id="articleComment_comment_type_0" value="Publish" checked="">
                               I am happy for my comment to be published online
                               </label>
                            </div>
                            <div class="radio">
                               <label>
                               <input type="radio" name="comment_type" id="articleComment_comment_type_1" value="Private">
                         ...
                         <div class="row">
                            <div class="col-sm-12 col-sm-offset-6">
                               <button class="btn btn-section btn-lg btn-block col-sm-24" type="submit">
                               Post comment
                               </button>
                            </div>
                         </div>
              ...
              <div class="col-sm-8 hidden-print">
                 ...
                 <div class="panel panel-default">
                    ...
                    <div class="list-group">
                       <a href="#" class="list-group-item">
                          Gulf jobs on the rise, driven by higher oil prices <br>
                          <ul class="list-inline text-sm text-supermuted">
                             <li>Mar 2018</li>
                             <li class="pull-right">
                                17,468
                 ...
                 <div class="panel panel-default">
                    ...
                    <div class="list-group">
                       <a href="<?php echo $base_url; ?>resources/employment_trends.php" class="list-group-item">
                          <div class="media">
                             ...
                             <div class="media-body">
                                Employment Trends
                                <p class="text-sm text-supermuted">(15)</p>
                             </div>
                          </div>
                       </a>
                       <a href="<?php echo $base_url; ?>resources/popular_employees.php" class="list-group-item">
                          <div class="media">
                             <div class="media-object pull-left">
                       ...
                       <a href="<?php echo $base_url; ?>resources/categories_salaries.php" class="list-group-item">
                          <div class="media">
                             <div class="media-object pull-left">
                       ...
                       <a href="<?php echo $base_url; ?>resources/workplace.php" class="list-group-item">
                          <div class="media">
                             <div class="media-object pull-left">
               ...
               <form class="form-horizontal" role="form">
                  <div class="form-group">
                     <div class="col-sm-20 col-sm-offset-2">
                        <input type="text" id="contact_us_name" name="name" required="required" class="form-control" message="Please enter name!" placeholder="Your Name" />
                     </div>
                  </div>
                  <div class="form-group">
                     <div class="col-sm-20 col-sm-offset-2">
                        <input type="email" id="contact_us_email" name="email" required="required"    class="form-control" message="Please enter a valid Email Address!" placeholder="Your Email Address" />
                     </div>
                  </div>
                  <div class="form-group space-bottom-base">
                     <div class="col-sm-20 col-sm-offset-2">
                        <textarea id="contact_us_message" name="message" required="required"    class="form-control" rows="8"  placeholder="Your comments/suggestions on the site"></textarea>
                     </div>
                  </div>
                  <div class="form-group space-bottom-base">
