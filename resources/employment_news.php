...
<main id="main-block"
   ...
   <div class="page-header">
      <div class="container">
         <div class="row">
            <div class="col-sm-24">
               <h1>Employment News</h1>
               <h2 class="f_font_21">Read latest news and articles covering wide range of employment topics in the Middle East</h2>
            </div>
         </div>
      </div>
   </div>
         ...
         <div class="row">
            ...
            <div class="col-sm-8
               ...
               <div class="panel panel-default f_panel">
                  <div class="panel-heading">
                     <div class="text-heading panel-title">Jobs by City</div>
                  </div>
                  <div class="list-group">
