                    ...
                    <div class="panel-body">
                       ...
                       <div class="row space-top-lg">
                          <div class="col-sm-12 col-sm-offset-6">
                             <a class="btn btn-primary btn-block btn-lg" onclick="modalOpen('cv_review_request_modal')">
...
<div id="cv_review_request_modal" class="w3-modal">
  <div class="modal-dialog">
     <div class="modal-content">
        <div>
           <div class="modal-header">
              <h2 class="modal-title">Free CV Review</h2>
              <div class="text-heading text-lg">Joblane has partnered with "TopCV" to bring you a one time expert CV evaluation for free</div>
              <button class="close" onclick="modalClose('cv_review_request_modal')">
           ...
           <div class="modal-body">
              <div class="row">
                 <div class="col-sm-24 space-bottom-sm space-top-xs">
                    <strong class="text-med text-regular">Sign-up with Joblane and upload your CV for a free review.</strong>
                 </div>
              </div>
              <form action="#" enctype="multipart/form-data" id="registration-step1" method="post" class="form-horizontal show-print-block section-jobs" name="registrationForm">
                 ...
                 <div class="row space-top-xs">
                    <div class=" col-sm-18 col-sm-offset-3 ">
                       <input type="hidden" name="cv_review_path" value="resources-new">
                       <div class="row">
                          <div class="col-sm-10">
                             <div class="row">
                                ...
                                <div class="col-sm-16 col-sm-offset-4">
                                   <div class="btn btn-tertiary btn-block btn-upload">
                                      Choose File
                             ...
                             <div class="row space-top-xs">
                                <div class="col-sm-16 col-sm-offset-4 label label-default" style="display: none;">
                                   ...
                                   <div class="text-sm text-link space-top-sm space-bottom-sm text-overflow">
                                   </div>
                                </div>
                             </div>
                          </div>
                       ...
                       <div>
                          <div class="form-group">
                             <div class="col-sm-1">
                                <input type="checkbox" id="mailing_MailpoolPermissionTypeTwo" name="MailpoolPermissionTypeTwo" value="YES">
                             </div>
                          ...
                          <div class="form-group">
                             <div class="col-sm-1">
                                <input type="checkbox" id="mailing_MailpoolPermissionTypeThree" name="MailpoolPermissionTypeThree" value="YES">
                             </div>
                             <span class="text-muted col-sm-22 col-sm-offset-1">
                             Please inform me about events, products and services from Joblane partners which may be of interest to me.
                             </span>
                          </div>
                       </div>
                       <div class="form-group">
                          <div class="col-sm-24">
                             <button class="btn btn-primary btn-block btn-lg col-sm-24" type="submit">
              ...
              <div class="row">
                 ...
                 <h3 class="text-left text-lg space-bottom-none">
                    ...
                    <a onclick="modalOpen('cv_review_login_modal'); modalClose('cv_review_request_modal')">
                    Log in
                    </a>
                 </h3>
              </div>
...
<div id="cv_review_login_modal" class="w3-modal">
  <div class="modal-dialog" style="margin-top: 79px;">
   <div class="modal-content">
         ...
         <div class="login-module">
            <div class="section-jobs">
               <div class="modal-header">
                  ...
                  <button class="close" onclick="modalClose('cv_review_login_modal')"><i class="fa fa-remove"></i></button>
               </div>
               <div class="modal-body">
                        ...
                        <div class="col-sm-12 col-xs-height">
                           <form  class="show-print-block">
                              ...
                              <div class="form-group">
                                 <div class="checkbox">
                                    <div class="row">
                                       ...
                                       <div class="col-sm-12">
                                          <a class="pull-right" onclick="modalOpen('cv_review_forgotpassword_modal'); modalClose('cv_review_login_modal')">
                                          Forgot password?
                                          </a>
                                       </div>
                                    </div>
                              ...
                              <div class="form-group space-bottom-none">
                                 <button class="btn btn-block btn-section col-sm-24">Login</button>
                              </div>
                           </form>
                        </div>
                        ...
                        <div class="col-sm-9 col-xs-height col-bottom">
                           ...
                           <div class="row">
                              <p class="space-top-xxl space-bottom-none text-right text-secondary">
                                 ...
                                 <a class="text-primary" onclick="modalOpen('cv_review_register_modal'); modalClose('cv_review_login_modal')">
                                 Register
                                 </a>
                              </p>
                           </div>
...
<div id="cv_review_forgotpassword_modal" class="w3-modal">
           ...
           <div class="login-module">
              <div class="section-jobs">
                 <div class="modal-header">
                    ...
                    <button class="close" onclick="modalClose('cv_review_forgotpassword_modal')"><i class="fa fa-remove"></i></button>
                 </div>
                 <div class="modal-body">
                    ...
                    <div class="row">
                       <div class="col-sm-12 col-sm-offset-6">
                          <form class="show-print-block">
                             ...
                             <div class="form-group space-bottom-none">
                                <button type="submit" class="btn btn-block btn-section col-sm-24">Submit</button>
                             </div>
                          </form>
                       </div>
                    </div>
...
<div id="cv_review_register_modal" class="w3-modal">
  <div class="modal-dialog">
     <div class="modal-content">
        <div>
           <div class="modal-header">
              ...
              <button class="close" onclick="modalClose('cv_review_register_modal')">
              <i class="fa fa-remove"></i>
              </button>
           </div>
           <div class="modal-body">
