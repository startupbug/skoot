...
<main id="main-block">
                  ...
                  <div class="col-sm-16 reset-width">
                     ...
                     <div class="panel panel-default">
                        ...
                        <div class="list-group">
                           ...
                           <h4 class="space-top-base space-bottom-base text-color">Any other enquiries?</h4>
                           ...
                           <div class="panel-body">
                              ...
                              <div class="text-heading text-muted space-bottom-xs">
                                 Contact Telephone
                                 <span class="text-supermuted">(Headquarters):</span>
                                 <span class="text-heading text-secondary">+971 4 123 456789</span>
                              </div>
                              <div class="text-muted text-heading space-bottom-xs">
                                 Office Hours:
   ...
   <section>
      ...
      <div class="feedback-btn-container affix-bottom affix-right space-right-base">
         ...
         <div class="panel panel-default space-bottom-none" collapse="isCollapsed" id="feedback">
            <div class="panel-heading">
