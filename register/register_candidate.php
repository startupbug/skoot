...
<main id="main-block">
   <div class="page-header" style="padding: 0px 0px;"></div>
   <div class="page-content">
      <section style="background-image: url(<?php echo $base_url;?>assets/images/register_hero_moving_people.jpg)"
         class="bg-cover">
         <div class="container">
            <div class="row">
               <div class="col-sm-24">
                  <h1 class="text-muted s_red_candidate">
                     Register for Jobs
                     <br>
                     <small class="text-secondary">
                     8,000 Employers
                     <i class="fa fa-circle text-sm"></i>
                     Over 4,000 Jobs
                     </small>
                  </h1>
               </div>
               <div class="col-sm-14">
                  <div class="panel panel-default bg-translucent-light panel-bordered">
                     <div class="panel-body">
                        <h4>Sign up for free and get the following benefits:</h4>
                        <ul class="list-symbol-check text-lg text-success">
                           <li><span class="text-secondary">Build a professional online CV</span></li>
                           <li><span class="text-secondary">Apply for jobs with top employers</span></li>
                           <li><span class="text-secondary">Recieve relevant job alerts by email</span></li>
                           <li><span class="text-secondary">Get noticed by top recruiters (optional)</span></li>
                        </ul>
                     </div>
                  </div>
               </div>
                     ...
                     <div class="panel-heading">
                        <div class="row space-bottom-sm">
                           <div class="col-sm-20 col-sm-offset-2">
                              <button class="btn btn-block btn-brand-facebook col-sm-24" style="width:100%">
                              ...
                              <div class="row row-xs-height">
                                 <div class=" col-sm-24 col-xs-height">
                                    <div class="form-group">
                                       <div class="col-sm-12">
                                          <input type="text" id="candidate_firstname" name="firstname" required="required"  class="form-control" placeholder="First Name" gt-model-value="" />
                                       </div>
                                       <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                       <div class="col-sm-24">
                                          <select id="candidate_CanLoc_location_current" name="location_current" required="required" class="form-control">
